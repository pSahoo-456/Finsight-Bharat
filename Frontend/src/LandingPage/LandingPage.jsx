  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white overflow-y-auto">
      ...
      <main className="w-full">
        {/* Upper Section */}
        <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-bl from-black to-blue-900">
          <img
            src="./FinBG.jpg"
            alt="background"
          ...
          <div className="relative z-10 text-center px-10 left-5">
            ...
            <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {/* GDP Card */}
              <motion.div
                className="bg-gray-800 p-6 rounded-xl text-center shadow-lg hover:scale-110 transition-all"
        ...
        <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-blue-950 px-10 py-16">
          ...
          <div className="text-left space-y-6">
            <h2 className="text-5xl font-bold">
              With <span className="text-blue-500">AI-Powered</span> Finacial Insights,
            </h2>
            <h2 className=" font-bold text-4xl">Make Smarter Economic Decisions effortlesly</h2>
            <p className="text-lg text-gray-400">
              Get started in just a few minutes
            </p>
            <ol className="list-decimal pl-6 text-lg space-y-2">
              <li>access real time Gdp,Inflation & Market Trends</li>
              <li>Generate Ai Drive and Finacial Reports</li>
          ...
          <div className="flex justify-center">
            <div className="relative w-80 h-80">
              ...
              <div className="absolute w-full h-full animate-spin-slow">
                <DotLottieReact className="w-[80rem] -ml-[30rem] -mt-44"
                  src="https://lottie.host/d0f3316f-1c92-428f-85d7-a7d3cfc559bb/xxGBdFuBaI.lottie"
                  loop
                  autoplay
                />
              </div>
